...
class HangmanGame(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.currentWord.setMinimumWidth(350)
    ...
    def guessClicked(self):
        ...
        if self.gameOver == True:
            ...
            self.message.setText("click new Game")
        ...
        if len(self.charInput.text()) != 1 :
            ...
            self.message.setText("input Alphabet")
        
        # 이미 사용한 글자인지를 판단하고, 아닌 경우 메시지 출력, 리턴
        if guessedChar in self.guess.guessedChars:
            self.message.setText("Please guess again")
        ...
        if success == False:
            ...
            # 메시지 출력
            self.message.setText("life decrease")
        ...
        if self.gameOver == False :
            ...
            self.hangmanWindow.setPlaceholderText(self.hangman.text[0])
